(function(){"use strict";panel.plugin("scottboms/microseasons",{sections:{microseasons:{data:function(){return{microSeason:Array}},created:function(){this.load().then(s=>{this.microSeason=s.microSeason})},template:`
